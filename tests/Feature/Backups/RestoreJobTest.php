...
function bindFakeCreateDatabaseService(): void
{
    $fakeDriver = new class implements DatabaseEngineDriver
    {
        ...
        public function stats(\App\Models\Database $database): DatabaseStats { return new DatabaseStats(0, 0); }
        public function capabilities(): EngineCapabilities { return new EngineCapabilities('MySQL', false, []); }
    };
